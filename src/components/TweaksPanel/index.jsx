...
export function TweaksPanel({ title = 'Tweaks', noDeckControls = false, children }) {
  ...
  const clamToViewport = React.useCallback(() => {
  ...
  React.useEffect(() => {
    ...
    if (typeof ResizeObserver === 'undefined') {
      window.addEventListener('resize', clamToViewport);
      return () => window.removeEventListener('resize', clamToViewport);
    }
    const ro = new ResizeObserver(clamToViewport);
      ...
      <div ref={dragRef} className="twk-panel" data-noncommentable=""
        ...
        <div className="twk-hd" onMouseDown={onDragStart}>
          ...
          <button className="twk-x" aria-label="Close tweaks"
                  onMouseDown={(e) => e.stoPropagation()}
